...
import { toFriendlyTimeEn } from "../../../../../../assets/utils";
  ...
  <div class="select-none">
    <div class="xs:mb-6 md:mb-5 flex" :class="{ 'justify-end': props.self }">
      ...
      <div class="mr-4" :class="{ 'ml-[36px]': props.followUp && !divider }">
        <div
          v-if="!hideAvatar()"
          :aria-label="props.message.user_info.name"
          class="outline-none"
        >
          <div
            :style="{ backgroundImage: `url(${ossURL + props.message.user_info.avatar})` }"
      ...
      <div class="flex items-end">
        ...
        >
          ...
          <Typography
            variant="body-2"
            noColor
            v-if="props.message.typeText === 'text' && props.message.content.text"
            class="outline-none text-black opacity-60 dark:text-white dark:opacity-70"
            v-html="linkifyStr(props.message.content.text, {
          ...
          <div
            v-else-if="
              props.message.content && props.message.typeText === 'voice'
            "
          >
            <RecordingV2 :message="props.message" :self="props.self"/>
          </div>

          <!--attachments-->
          <AttachmentsV2
            v-if="props.message.type === 2 || props.message.type === 3 || props.message.type === 4"
        ...
        <div :class="props.self ? ['ml-4', 'order-1'] : ['mr-4']">
          <Typography variant="body-1" class="whitespace-pre">
            {{ toFriendlyTimeEn(props.message.time) }}
          </Typography>
        </div>
