...
<template>
  <div class="mb-7 h-7 xs:hidden md:block">
    <a href="#mainContent" title="Skip to main content" @blur="SkipLinkFocused = false" @focus="SkipLinkFocused = true"
    ...
    <button aria-label="avian logo" :class="{ hidden: SkipLinkFocused }" class="outline-none">
      <img src="@src/assets/images/logo.png" class="w-8 h-7" alt="gray bird logo" />
      <!--<img-->
